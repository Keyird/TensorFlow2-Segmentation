...
def generate_arrays_from_file(lines, batch_size=4):
    ...
    while 1:
        ...
        for _ in range(batch_size):
            ...
            img = Image.open("/home/fmc/WX/Segmentation/SegNet-tf2/dataset/jpg" + '/' + name)
            ...
            # 从文件中读取标签图像
            img = Image.open("/home/fmc/WX/Segmentation/SegNet-tf2/dataset/png" + '/' + name)
...
if __name__ == "__main__":
    ...
    weights_path = "/home/fmc/WX/Segmentation/SegNet-tf2/pretrained/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"
    model.load_weights(weights_path, by_name=True)

    with open("/home/fmc/WX/Segmentation/SegNet-tf2/dataset/train.txt", "r") as f:
        lines = f.readlines()
